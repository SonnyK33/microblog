...
def search():
    ...
    prev_url = url_for('main.search', q=g.search_form.q.data, page=page-1) if total > 1 else None
...
def index():
    ...
    # posts =[{'author':{'username':'John'},'body':'nice day in Portland'},
    # {'author':{'username':'Susan'},'body':'Avengers movie was cool'}]  
